...
public class SuggAdapter extends android.widget.ArrayAdapter<List<Suggestion>>{

    Context context;
    List<Suggestion> sugs;
    SugListener suglisten = new SugListener();
    public SuggAdapter(Context context, int textViewResourceId, List<Suggestion> objects) {
